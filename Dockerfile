...
RUN http_proxy="${http_proxy}" https_proxy="${https_proxy}" install2.r --error --deps TRUE optparse dplyr reshape2 readr smoother stringr tidyr spatstat openssl R.utils
